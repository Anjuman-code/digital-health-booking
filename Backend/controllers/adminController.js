...
const addDoctor = async (req, res) => {
  try {
    ...
    console.log("📧 Email:", email);
    console.log("🔑 Login Password:", finalPassword);
    ...
    log(`Triggering welcome email to ${email} in background`);
    ...
    // Respond immediately since email is being processed in background
    log("Doctor created successfully, email queued");
    res.json({
      success: true,
      message:
        "Doctor Added Successfully. Login credentials will be sent via email.",
    });
  } catch (error) {
